...
# ds = read_tsv('~/Documents/Webcorpus2/dani_virag/virag_dani_web_archiv/bigram_freqs_simple_min10.tsv.gz') # contains non-alphanumeric characters
dp = read_tsv('~/Documents/Webcorpus2/dani_virag/virag_dani_web_archiv/bigram_freqs_processed_min10.tsv.gz', col_names = F) # doesn't contain non-a ch
